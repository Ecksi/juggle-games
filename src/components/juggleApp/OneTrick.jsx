...
export default function OneTrick() {
  ...
  return (
    ...
    <Box sx={{ 
      ...
      <Box sx={{ gridArea: 'animation' }}>
        <Typography variant="body2" paragraph style={{height:100+"%", marginTop:24+"px"}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis, fugit optio natus esse nemo ullam ex, corporis dicta impedit commodi velit odit eum, ratione sed eligendi aspernatur amet temporibus quibusdam.</Typography>
        <Typography variant="body1">
          Prerequisites
        </Typography>
        <List>
    ...
    <Typography variant="h3" style={{marginTop: '50px'}}>Option 3</Typography>
    <Box sx={{ 
      display: 'grid',
      gridTemplateColumns: 'repeat(2, 1fr)',
      alignItems: 'center',
